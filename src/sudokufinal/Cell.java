...
// This class is self configuring and every cell finds out about its place and function
// by the order in which it was instantiated.
public class Cell {
	...
	public boolean isUniqueInRow() throws InterruptedException {			// Checks against the grid whether the cell is unique in its row.
